...
const[Webserve,setWebserve]=useState([
  ...
  background: "https://qubicgen-prod.s3.us-east-1.amazonaws.com/Services/Web+Development/who+we+server/web_health.jpg"
  },
  ...
  background: "https://qubicgen-prod.s3.us-east-1.amazonaws.com/Services/Web+Development/who+we+server/web_finance.jpg"
  },
  {
    title: 'Education',
    ...
    background: "https://qubicgen-prod.s3.us-east-1.amazonaws.com/Services/Web+Development/who+we+server/web_education.jpg"
    },
  {
  title: 'Entertainment',
  ...
  background: "https://qubicgen-prod.s3.us-east-1.amazonaws.com/Services/Web+Development/who+we+server/web_entertainemnt.avif"
  },
  {
  title: 'Travel',
  ...
  background: "https://qubicgen-prod.s3.us-east-1.amazonaws.com/Services/Web+Development/who+we+server/web_travel.jpg"
  },
...
<Link className='hover:cursor-pointer' to="querie" spy={true} smooth={true} offset={-200} duration={200}><li>Queries</li></Link>
   ...
   <div className="col-md-5" bis_skin_checked="1">
     <img src="https://qubicgen-prod.s3.us-east-1.amazonaws.com/Services/Web+Development/web_head.jpg"  alt="" />
   </div>
 </div>
    </div>
