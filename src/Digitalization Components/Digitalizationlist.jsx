  ...
  const [DigitalizationServe, setDigitalizationServe] = useState([
    {
        ...
        background: "https://qubicgen-prod.s3.us-east-1.amazonaws.com/Services/Digitalization/digitalization_serving/digitalization_health.jpg"
        },
        
        {
        title: 'Education',
        description: 'Deliver engaging learning through e-learning platforms, virtual classrooms and adaptive learning technologies.',
        background: "https://qubicgen-prod.s3.us-east-1.amazonaws.com/Services/Digitalization/digitalization_serving/digitalization_education.jpg"
        },
        {
        title: 'Manufacturing',
        description: 'Optimize production with Industry 4.0 solutions like IoT, robotics and predictive maintenance.',
        background: "https://qubicgen-prod.s3.us-east-1.amazonaws.com/Services/Digitalization/digitalization_serving/digitalization_manufacturing.jpg"
        },
        {
        ...
        background: "https://qubicgen-prod.s3.us-east-1.amazonaws.com/Services/Digitalization/digitalization_serving/digitalization_energy.webp"
        },
        {
        title: 'Finance',
        description :'Streamline financial services through online banking, mobile payments and AI-powered solutions.',
        background: "https://qubicgen-prod.s3.us-east-1.amazonaws.com/Services/Digitalization/digitalization_serving/digitalization_finance.jpg"
        },
        {
        title: 'Government',
        description: 'Improve citizen engagement with online portals, digital identity systems and smart city initiatives.',
        background: "https://qubicgen-prod.s3.us-east-1.amazonaws.com/Services/Digitalization/digitalization_serving/digitalization_government.jpg"
        },
        {
        title: 'Media & Entertainment',
        description: 'Captivate audiences with streaming services, social media integration and immersive experiences.',
        background: "https://qubicgen-prod.s3.us-east-1.amazonaws.com/Services/Digitalization/digitalization_serving/digitalization_media.jpg"
        },
        {
        ...
        background: "https://qubicgen-prod.s3.us-east-1.amazonaws.com/Services/Digitalization/digitalization_serving/digitalization_transportation.png"
        },
        {
        title: 'Retail',
        ...
        background: "https://qubicgen-prod.s3.us-east-1.amazonaws.com/Services/Digitalization/digitalization_serving/digitalization_retail.webp"
        }
    ]);
  // This is for rpa offering cards
   ...
   <div id='overview'>
    ...
    <div className="row featurette" bis_skin_checked="1" style={{marginTop:'100px'}} >
      ...
      <div className="col-md-5" bis_skin_checked="1">
        <img src="https://qubicgen-prod.s3.us-east-1.amazonaws.com/Services/Digitalization/digitalization_overview.jpeg"  alt="" />
      </div>
    </div>
    </div>
