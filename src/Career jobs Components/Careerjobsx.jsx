...
<div className="Careersjobsmain flex bg-center justify-center items-center sm:h-10 " style={{background:"url('https://res.cloudinary.com/defsu5bfc/image/upload/v1711097450/QubicGen/Careers/Job%20Search%20Page/smiling-young-woman-glasses-showing-laptop-screen-deal-thumb-up-recommending-offer-standing-o_7_bdyirn.jpg')",backgroundPosition:'bottom',backgroundRepeat:'no-repeat',backgroundSize:'cover'}}>
    <div className="z-50 text-2xl ml-3 text-white sm:mx-6  md:text-4xl md:mr-80 lg:text-5xl lg:mb-10 h-36 md:w-96 lg:w-auto xl:w-auto flex flex-col justify-center items-center" style={{backgroundColor:'rgba(0,0,0,0.6)'}}>
       <p className='text-xl md:text-2xl lg:text-3xl xl:text-3xl'>Discover Your Dream Job Here!</p>
       <div>
