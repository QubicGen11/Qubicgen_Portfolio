      ...
      />
              ...
              <div className='bg-black'>
                  <div className="careeesfull bg-black" data-aos="fade-right">
                      <div className="Careersjobsmain flex bg-center justify-center items-center sm:h-10 " style={{ background: "url('https://qubicgen-prod.s3.us-east-1.amazonaws.com/Careers/portrait-businessman-smiling.jpg')", backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }}>
