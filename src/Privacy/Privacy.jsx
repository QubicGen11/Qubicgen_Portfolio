...
const Privacy = () => {
  return (
    ...
    <div className="lg:max-w-9xl lg:mx-48 xl:max-w-9xl xl:mx-48 py-3 text-white">
            <h1 className="text-5xl font-bold mb-4">Privacy Policy</h1>
            <p className="mb-2">Last updated: December 4, 2023</p>
            <p className='text-base font-light'>
    Please read these terms and conditions carefully before using Our Service.
  </p>
  <h2 className="text-2xl font-light mt-6 mb-2">Interpretation and Definitions</h2>
  <h3 className="text-2xl font-light">Interpretation</h3>
  <p className='text-base font-light'>
    The words of which the initial letter is capitalized have meanings defined
    under the following conditions. The following definitions shall have the
    same meaning regardless of whether they appear in singular or in plural.
  </p>
  <h3 className="text-2xl font-light">Definitions</h3>
  ...
  <ul>
    ...
    <li>
      <p className='text-base font-light'>
        ...
        "Us" or "Our" in this Agreement) refers to QubicGen, Opp Govt
        Polytechnic College, Anantapur, Andhra Pradesh.
      </p>
    </li>
    <li>
      <p className='text-base font-light'>
    ...
    <li>
      <p className='text-base font-light'>
        <strong>Website</strong> refers to QubicGen, accessible from{" "}
        <a
          href="https://www.qubicgen.com/"
  ...
  <h2 className="text-2xl font-light mt-6 mb-2">Acknowledgment</h2>
  <p className='text-base font-light'>
  ...
  <h2 className="text-2xl font-light mt-6 mb-2">Links to Other Websites</h2>
  <p className='text-base font-light'>
  ...
  <h2 className="text-2xl font-light mt-6 mb-2">Termination</h2>
  <p className='text-base font-light'>
    We may terminate or suspend Your access immediately, without prior notice or
    liability, for any reason whatsoever, including without limitation if You
    breach these Terms and Conditions.
  </p>
  <p className='text-base font-light'>Upon termination, Your right to use the Service will cease immediately.</p>
  <h2 className="text-2xl font-light mt-6 mb-2">Limitation of Liability</h2>
  <p className='text-base font-light'>
  ...
  <h2 className="text-2xl font-light mt-6 mb-2">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
  <p className='text-base font-light'>
  ...
  <h2 className="text-2xl font-light mt-6 mb-2">Governing Law</h2>
  <p className='text-base font-light'>
  ...
  <h2 className="text-2xl font-light mt-6 mb-2">Disputes Resolution</h2>
  <p className='text-base font-light'>
  ...
  <h2 className="text-2xl font-light mt-6 mb-2">For European Union (EU) Users</h2>
  <p className='text-base font-light'>
    If You are a European Union consumer, you will benefit from any mandatory
    provisions of the law of the country in which You are resident.
  </p>
  <h2 className="text-2xl font-light mt-6 mb-2">United States Legal Compliance</h2>
  <p className='text-base font-light'>
  ...
  <h2 className="text-2xl font-light mt-6 mb-2">Severability and Waiver</h2>
  <h3 className="text-2xl font-light">Severability</h3>
  <p className='text-base font-light'>
  ...
  <h3 className="text-2xl font-light">Waiver</h3>
  <p className='text-base font-light'>
  ...
  <h2 className="text-2xl font-light mt-6 mb-2">Translation Interpretation</h2>
  <p className='text-base font-light'>
    These Terms and Conditions may have been translated if We have made them
    available to You on our Service. You agree that the original English text
    shall prevail in the case of a dispute.
  </p>
  <h2 className="text-2xl font-light mt-6 mb-2">Changes to These Terms and Conditions</h2>
  <p className='text-base font-light'>
  ...
  <h2 className="text-2xl font-light mt-6 mb-2">Contact Us</h2>
        {/* Other content */}
  ...
  <ul>
    <li>
        <a href="mailto:services@qubicgen.com" className='text-base font-light'>
        By email: services@qubicgen.com
        </a>
    </li>
    <li>
      <p  className='text-base font-light'>
        ...
        <a
          ...
          target="_blank"
        >
          https://www.qubicgen.com/contact
        </a>
      </p>
    </li>
    <li>
        <a href="tel:+919649749845">By phone number: 9649749845</a>
    </li>
  </ul>
        </div>
