...
const Contact = () => {
  ...
  const handleFormSwitch = (type) => {
    ...
    clearFormData(); // Clear form data when switching form types
  };
        ...
        <div className="containerone">
          <div className="forms-container">
            ...
            <form onSubmit={handleSubmit} className="sign-in-form">
                ...
                <div className="input-field" style={{ height: '20vh' }}>
                  ...
                  <input type="text" placeholder="Enter your Queries" name="message" onChange={handleChange} value={formData.message} />
                </div>
          ...
          <div className="panel left-panel">
              <div className="content" id="lookingproject">
                ...
                <button className="btnone" id="sign-up-btn" onClick={() => handleFormSwitch('project')} style={{ width: '170px', position: 'relative', left: '76px', height: '50px', marginTop: '30px' }}>
                  Project Form
                </button>
              </div>
          </div>
          ...
          <div className="panel right-panel" style={{ position: 'relative', left: '-150px' }}>
              ...
              <h3 style={{ fontSize: '45px' }}>Want to Learn Skills?</h3>
                ...
                <button className="btnone" id="sign-in-btn" onClick={() => handleFormSwitch('student')} style={{ width: '170px', position: 'relative', left: '140px', height: '50px' }}>
                  Student Form
                </button>
              </div>
          </div>
