...
const Queries = () => {
 ...
 <div>
  <section className="min-h-screen flex items-stretch text-white" data-aos="fade-up">
    ...
    <div className="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" style={{backgroundImage: 'url(https://img.freepik.com/free-photo/person-holding-question-mark_1134-489.jpg?t=st=1709198676~exp=1709202276~hmac=21a1e9f0a8b9d0a817e977aafcbac5080afa1bf6109205d8667de5c042f72357&w=996)'}}>
    ...
    <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style={{backgroundColor: '#161616'}}>
      <div className="absolute lg:hidden z-10 inset-0 bg-gray-500 bg-no-repeat bg-cover items-center" style={{backgroundImage: 'url(https://img.freepik.com/free-photo/person-holding-question-mark_1134-489.jpg?t=st=1709198676~exp=1709202276~hmac=21a1e9f0a8b9d0a817e977aafcbac5080afa1bf6109205d8667de5c042f72357&w=996)'}}>
        <div className="absolute bg-black opacity-60 inset-0 z-0" />
      </div>
