...
const Queries = () => {
 ...
 <div>
  <section className="min-h-screen flex items-stretch text-white" data-aos="fade-up">
    ...
    <div className="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" style={{backgroundImage: 'url(https://img.freepik.com/free-photo/question-mark-icon-solving-problem-solution-concept_53876-13887.jpg?t=st=1709199021~exp=1709202621~hmac=2067abb12d3013a72d234f13b32cd1d74d37c36d951a584af70f49702b366cb8&w=996)' ,backgroundPosition:'center'}}>
    ...
    <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style={{backgroundColor: '#161616'}}>
      <div className="absolute lg:hidden z-10 inset-0 bg-gray-500 bg-no-repeat bg-cover items-center" style={{backgroundImage: 'url(https://img.freepik.com/free-photo/question-mark-icon-solving-problem-solution-concept_53876-13887.jpg?t=st=1709199021~exp=1709202621~hmac=2067abb12d3013a72d234f13b32cd1d74d37c36d951a584af70f49702b366cb8&w=996)',backgroundPosition:'center'}}>
        <div className="absolute bg-black opacity-60 inset-0 z-0" />
      </div>
