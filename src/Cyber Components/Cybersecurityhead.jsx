...
const Cybersecurityhead = () => {
  return (
    <>
      
    

 <div className="cybersecurityhead d-flex align-items-center justify-content-start" data-aos="fade-right">
    <div className="text-start mx-5 mb-28 ">
...
export default Cybersecurityhead