...
const ExploreQubicgen = () => {
    return (

        <>

            <div className="text-2xl ml-4 sm:text-2xl sm:ml-6 md:ml-6 lg:text-4xl lg:ml-10  text-white" data-aos="fade-up">
                Explore <span style={{ color: 'gold' }}>QubicGen :</span>
            </div>


            <div className="maincareers md:flex lg:mt-6" data-aos="fade-up">
            ...
            <img className='rounded-lg  ' src="https://res.cloudinary.com/defsu5bfc/image/upload/v1710787174/QubicGen/Careers/Why%20QubicGen/young-person-during-intership_23-2149315625_lbapq4.jpg" alt="" style={{width:'80vw'}} />
                ...
                <div className="careersright flex lg:items-center xl:items-center">
                    <p className='text-white mx-3 mt-1 font-thin ml-4 py-4 text-1xl md:ml-6 lg:text-base lg:ml-10'>QubicGen is your gateway to a
            ...
            <div className="maincareerstwo md:flex flex-row-reverse" data-aos="fade-up">
                ...
                <div className="careersright flex lg:items-center xl:items-center">
                    <p className='text-white mx-5 mt-1 font-thin ml-4 py-4 text-1xl md:ml-6 lg:text-base lg:ml-10'>QubicGen is your gateway to a
            ...
            <div className="maincareersthree md:flex" data-aos="fade-up">
...
<div className="careersright flex lg:items-center xl:items-center">
    <p className='text-white mx-3 mt-1 font-thin ml-4 py-4 text-1xl md:ml-6 lg:text-base lg:ml-10'>At QubicGen, career paths are as diverse as our team members' ambitions. Whether you're a seasoned professional or just starting your journey, we offer opportunities for growth and advancement across various disciplines. From technical roles to 
...
<div className="maincareersfour md:flex flex-row-reverse">
...
<div className="careersright flex lg:items-center xl:items-center">
    <p className='text-white mx-5 mt-1 font-thin ml-4 py-4 text-1xl md:ml-6 lg:text-base lg:ml-10'>We prioritize the well-being and success of our team members by offering a comprehensive range of benefits and perks. From competitive compensation packages to flexible work arrangements, we strive to create an environment where employees feel valued and supported. Additionally, we provide opportunities for professional development, including access to training programs and mentorship opportunities.
    </p>
...
export default ExploreQubicgen